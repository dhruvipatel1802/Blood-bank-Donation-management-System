  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\blood2.jpg" alt="blood2.jpg" width="100%" height="450" style="border-radius: 30px; -moz-border-radius: 30px;">
      </div>
      <div class="carousel-item">
        <img src="image\donationFact.jpg" alt="image\donationFact.jpg" width="100%" height="400" style="border-radius: 30px; -moz-border-radius: 30px;">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:55px;color:red;font-family:'Sans-serif';font-weight:bold;">Welcome to BloodBank & Donor Management System</h1>
<br>
        <div class="row">
        ...
        <h2 style="color:red;font-size:40px;font-family:'Sans serif';font-weight:bold;">BLOOD DONOR NAMES</h2>
          ...
          <?php
           ...
           ?>
            ...
            <div class="card" style="width:300px">
                <img class="card-img-top" src="image\b-bank-1.png" alt="Card image" style="width:100%;height:300px">
                <div class="card-body">
                  <h3 class="card-title"><?php echo $row['donor_name']; ?></h3>
                  <p class="card-text">
                    <b>Blood Group : </b> <b><?php echo $row['blood_group']; ?></b><br>
                    <b>Email Id: : </b> <?php echo $row['donor_mail']; ?><br>
...
<br>
        ...
        <div class="row">
            <div class="col-lg-6">
                <h2 style="color:red;font-size:40px;font-family:'Sans serif';font-weight:bold;">BLOOD GROUPS</h2>
                <p>
                  <?php
                    include 'conn.php';
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\bank.png" alt="" >
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row mb-4">
            <div class="col-md-8">
            <h4 style="color:red;font-size:40px;font-family:'Sans serif';font-weight:bold;">UNIVERSAL DONORS AND RECIPIENTS</h4>
            <p>
              <?php
                include 'conn.php';
