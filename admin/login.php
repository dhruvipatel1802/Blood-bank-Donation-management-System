...
<body background="admin_image\blood-cells.jpg" style="repeat:no-repeat">
...
<style>
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      ...
      <div class="card" style="height:500px;background-image:url('admin_image/glossy2.jpg');opacity:75%; font:">
      <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="color:black; position:relative; left:70%;font-size:50px;font-weight:bold;">
